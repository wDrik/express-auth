...
router.post('/projects', authMiddleware, aclMiddleware, ProjectController.store);
router.put('/projects/:projectId', authMiddleware, aclMiddleware, ProjectController.update);
router.delete('/projects/:projectId', authMiddleware, aclMiddleware, ProjectController.remove);
